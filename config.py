...
class PretrainConfig:
    ...
    phase1_micro_batch_per_gpu: int = 32          # 32 seqs × 512 = 16,384 tokens/micro-step
    phase2_micro_batch_per_gpu: int = 16          # 16 seqs × 2048 = 32,768 tokens/micro-step
    phase3_micro_batch_per_gpu: int = 8           # 8 seqs × 4096 = 32,768 tokens/micro-step
