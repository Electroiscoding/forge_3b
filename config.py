...
class PretrainConfig:
    ...
    micro_batch_size_per_gpu: int = 24            # default fallback
    phase1_micro_batch_per_gpu: int = 64          # 64 seqs × 512 = 32,768 tokens/micro-step
    phase2_micro_batch_per_gpu: int = 24          # 24 seqs × 2048 = 49,152 tokens/micro-step
    phase3_micro_batch_per_gpu: int = 12          # 12 seqs × 4096 = 49,152 tokens/micro-step
