...
PHASE1_MICRO_BATCH="${PHASE1_MICRO_BATCH:-32}"   # 32 seqs × 512 = 16,384 tokens/step
PHASE2_MICRO_BATCH="${PHASE2_MICRO_BATCH:-16}"   # 16 seqs × 2048 = 32,768 tokens/step
PHASE3_MICRO_BATCH="${PHASE3_MICRO_BATCH:-8}"    # 8 seqs × 4096 = 32,768 tokens/step
